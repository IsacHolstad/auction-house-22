...
async function getAuctionById() {
    ...
    const {title, description, tags, media, created,  updated, endsAt, seller, name, email, avatar, id, count, amount} = data;
    spesificAuctionItem.innerHTML = `<div class="mt-8">
                <div class="border border-black-700 shadow rounded-xl p-4 max-w-4xl w-full mx-auto h-96">
